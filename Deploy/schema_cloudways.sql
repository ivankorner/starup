-- ============================================================================
-- Radar de Proyectos — Schema para Cloudways
-- Base de datos: tpwtvzukqe (ya creada por Cloudways)
--
-- INSTRUCCIONES:
-- 1. Ir a Cloudways Panel → Tu App → Database Manager (Adminer)
-- 2. Click en "SQL command" o "Import"
-- 3. Pegar/importar este archivo completo
-- ============================================================================
...
-- ============================================================================
-- TABLA: submissions (formulario Radar original)
-- ============================================================================
